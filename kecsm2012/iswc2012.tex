...
\titlerunning{SEFI@home, or Opening the Google Knowledge Graph}
\authorrunning{SEFI@home, or Opening the Google Knowledge Graph}
...
% RV: Might be wortwhile to add annotations to the screenshot.
